...
export function BoardDemo({
  ...
  moves,
  children,
}: Omit<BoardBlock, "type"> & { children?: ReactNode }) {
  ...
  return (
    <div className="my-6 mx-auto grid w-full max-w-3xl items-center gap-8 md:grid-cols-[minmax(0,400px)_1fr] lg:gap-10">
      ...
      <div className="min-w-0 text-[15px] leading-7 text-zinc-800 dark:text-zinc-200">
        {children}
